...
(function(d) {
                    ...
                    if (d.isArray(o)) this._expandButton(a, o, c, e);
                        ...
                        j &&
                            (e !== m ? (a.splice(e, 0, j), e++) : a.push(j),
                                j.conf.buttons && ((j.collection = d("<" + this.c.dom.collection.tag + "/>")), (j.conf._collection = j.collection), this._expandButton(j.buttons, j.conf.buttons, !0, e)),
    ...
    n.instanceSelector = function(a, b) {
        ...
        var c = [],
            ...
            g = function(a) {
                if (d.isArray(a))
                    for (var h = 0, l = a.length; h < l; h++) g(a[h]);
    ...
    i.Api.register("buttons().containers()", function() {
        ...
        this.iterator(!0, "table", function(c) {
            if (c._buttons)
                for (var c = n.instanceSelector(b, c._buttons), d = 0, g = c.length; d < g; d++) a = a.add(c[d].container());
        });
        return a;
    });
    ...
    i.Api.register("buttons.exportData()", function(a) {
        if (this.context.length) {
            ...
            for (var f = b.rows(c.rows, f).indexes().toArray(), h = b.cells(f, c.columns), f = h.render(c.orthogonal).toArray(), h = h.nodes().toArray(), l = a.length, k = [], j = 0, n = 0, q = 0 < l ? f.length / l : 0; n < q; n++) {
    ...
    i.Api.register("buttons.exportInfo()", function(a) {
        ...
        b === m || null === b ? (b = null) : (-1 !== b.indexOf("*") && (b = d.trim(b.replace("*", d("head > title").text()))), (b = b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "")), (c = s(c.extension)) || (c = ""), (b += c));
        c = s(a.title);
